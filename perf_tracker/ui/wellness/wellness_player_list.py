"""
ui/wellness_player_list.py
Liste des joueurs pour sélectionner qui remplit son wellness.
"""
...
class WellnessPlayerList(QWidget):
    ...
    def _build_ui(self):
        ...
        title = QLabel("Wellness — Sélectionner un joueur")
    ...
    def _load_players(self):
        ...
        for player in players:
            ...
            card = self._make_player_card(player, wellness_submitted)
            self.list_layout.addWidget(card)

        self.list_layout.addStretch()

    def _make_player_card(self, player: dict, wellness_submitted: bool) -> QFrame:
